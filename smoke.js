...
// Begin JS library code
  ...
  function __ZSt9terminatev(...args
  ) {
  abort('missing function: _ZSt9terminatev');
  }
  __ZSt9terminatev.stub = true;

  function __ZdlPvm(...args
  ) {
  abort('missing function: _ZdlPvm');
  }
  __ZdlPvm.stub = true;
  ...
  function ___cxa_begin_catch(...args
  ) {
  abort('missing function: __cxa_begin_catch');
  }
  ___cxa_begin_catch.stub = true;

  function ___cxa_find_matching_catch_3(...args
  ) {
  abort('missing function: __cxa_find_matching_catch_3');
  }
  ___cxa_find_matching_catch_3.stub = true;
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(2, 0, 1, target, width, height);
...
function assignWasmExports(wasmExports) {
  ...
  function assignWasmImports() {
    wasmImports = {
    /** @export */
    _ZSt9terminatev: __ZSt9terminatev,
    /** @export */
    _ZdlPvm: __ZdlPvm,
    /** @export */
